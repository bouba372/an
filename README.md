...
This repository uses a single GitHub Actions workflow in [.github/workflows/ci.yml](.github/workflows/ci.yml) for CI checks only.

### CI

CI runs on push and pull request for `dev`, plus manual trigger (`workflow_dispatch`).
